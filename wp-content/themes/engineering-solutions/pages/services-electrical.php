...
<head>
    ...
    <title>Electrical design & CAD/BIM services</title>
        ...
        <div class='container'>
            <div class='electrical-content-inner'>
                <div class='electrical-content-image'>
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/electrical-content-image.jpg' alt=''>
                </div>
                <div class='electrical-content-description'>
                    ...
                    <p>
                        Our team works in AutoCAD and AutoCAD Electrical for 2D designs and Revit for 3D design & BIM.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class='electrical-slider-image'>
                            <img src='<?php echo get_template_directory_uri() ?>/assets/images/electrical-slider-image.png' alt=''>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class='electrical-slider-image'>
...
<footer class='footer electrical-footer'>
...
<script src='../assets/js/electrical.js'></script>
</body>
</html>